...
namespace OLT.Extensions.Caching.Tests
{
    ...
    public class RedisCacheGeneral
    {
        ...
        public void ExtensionExceptionTests()
        {
            ...
            RedisConfiguration options = null;
            ...
            options = new RedisConfiguration();
        ...
        {
            var provider = TestHelper.BuildRedisProvider(_config, TimeSpan.FromSeconds(4), "TimeoutTests");
        ...
        {
            var provider = TestHelper.BuildRedisProvider(_config, TimeSpan.FromSeconds(2), "TimeoutAsyncTests");
            var cacheService = provider.GetRequiredService<IOltCacheService>();
