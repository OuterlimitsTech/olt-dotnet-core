...
//            var paged = OltWhereExtensions.ToPaged(queryable, @params);
...
//            var paged = OltWhereExtensions.ToPaged(queryable, @params, _defaultOrder);
...
//            Assert.Throws<ArgumentNullException>(() => OltWhereExtensions.ToPaged<PersonEntity>(null, null));
//            Assert.Throws<ArgumentNullException>(() => OltWhereExtensions.ToPaged<PersonEntity>(queryable, null));
//            Assert.Throws<ArgumentNullException>(() => OltWhereExtensions.ToPaged<PersonEntity>(null, @params));
//        }
