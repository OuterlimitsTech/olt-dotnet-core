...
public class EntityUidServiceTests : BaseUnitTests
{
    ...
    public async Task SoftDelete()
    {
        using (var provider = BuildProvider())
        {
            ...
            Assert.NotNull(await service.GetAsync<PersonDetailDto>(new OltSearcherGetByUid<PersonEntity>(model.UniqueId.Value, true)));
            Assert.Null(await service.GetAsync<PersonDetailDto>(new OltSearcherGetByUid<PersonEntity>(model.UniqueId.Value, false)));
            Assert.Null(await service.GetAsync<PersonDetailDto>(new OltSearcherGetByUid<PersonEntity>(model.UniqueId.Value)));
        }
        ...
        using (var provider = BuildProvider())
        {
            ...
            var model = service.Add(PersonDetailDto.FakerEntity());
            ...
            Assert.NotNull(service.Get<PersonDetailDto>(new OltSearcherGetByUid<PersonEntity>(model.UniqueId.Value, true)));
            Assert.Null(service.Get<PersonDetailDto>(new OltSearcherGetByUid<PersonEntity>(model.UniqueId.Value, false)));
            Assert.Null(service.Get<PersonDetailDto>(new OltSearcherGetByUid<PersonEntity>(model.UniqueId.Value)));
        }
    }
    ...
    public async Task Get()
    {
        using (var provider = BuildProvider())
        {
            ...
            var expected = service.Add(PersonDetailDto.FakerEntity());
            var subject = await service.GetAsync<PersonDetailDto>(expected.UniqueId.GetValueOrDefault());
        ...
        using (var provider = BuildProvider())
        {
            ...
            var expected = service.Add(PersonDetailDto.FakerEntity());
            var subject = service.Get<PersonDetailDto>(expected.UniqueId.GetValueOrDefault());
            subject.Should().BeEquivalentTo(expected);
        }
    ...
    public async Task GetPaged()
    {
        ...
        using (var provider = BuildProvider())
        {
            ...
            var paged1 = await service.GetPagedAsync<PersonDetailDto>(new OltSearcherGetAll<PersonEntity>(), pagedParams);
            ...
            var paged2 = service.GetPaged<PersonDetailDto>(new OltSearcherGetAll<PersonEntity>(), pagedParams);
            ...
            var paged3 = await service.GetPagedAsync<PersonDetailDto>(new OltSearcherGetAll<PersonEntity>(), pagedParams, orderBy => orderBy.OrderBy(p => p.NameFirst).ThenBy(p => p.NameLast).ThenBy(p => p.Id));
            ...
            var paged4 = service.GetPaged<PersonDetailDto>(new OltSearcherGetAll<PersonEntity>(), pagedParams, orderBy => orderBy.OrderBy(p => p.NameFirst).ThenBy(p => p.NameLast).ThenBy(p => p.Id));
