...
public class ContextServiceTests : BaseUnitTests
{
    ...
    public void Get()
    {
        using (var provider = BuildProvider())
        {
            ...
            Assert.Throws<OltAdapterNotFoundException<UserEntity, UserModel>>(service.GetAllUsers);
            Assert.Throws<OltAdapterNotFoundException<UserEntity, UserModel>>(service.GetAllUsersSearcher);
    ...
    public async Task GetAsync()
    {
        using (var provider = BuildProvider())
        {
            ...
            await Assert.ThrowsAsync<OltAdapterNotFoundException<UserEntity, UserModel>>(service.GetAllUsersAsync);
            await Assert.ThrowsAsync<OltAdapterNotFoundException<UserEntity, UserModel>>(service.GetAllUsersOrderedAsync);
            await Assert.ThrowsAsync<OltAdapterNotFoundException<UserEntity, UserModel>>(service.GetAllUsersSearcherAsync);
