namespace OLT.Core
{
        ...
        where TEntity : class, IOltEntityId, IOltEntity
    {
        ...
        Task<TModel?> GetAsync<TModel>(int id, bool includeDeleted) where TModel : class, new();
        ...
        Task<TModel> UpdateAsync<TModel>(int id, TModel model, CancellationToken cancellationToken = default) where TModel : class, new();
        ...
        Task<TResponseModel> UpdateAsync<TResponseModel, TSaveModel>(int id, TSaveModel model, CancellationToken cancellationToken = default)
            where TResponseModel : class, new()
            where TSaveModel : class, new();
