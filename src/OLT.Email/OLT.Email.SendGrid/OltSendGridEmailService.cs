...
{
    public class OltSendGridEmailService : OltEmailServiceBase<OltEmailConfigurationSendGrid>
    {
        

        public OltSendGridEmailService(IOptions<OltEmailConfigurationSendGrid> options)
        {
            Configuration = options.Value;
        }

        protected override OltEmailConfigurationSendGrid Configuration { get; }
